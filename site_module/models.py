...
class SiteSetting(models.Model):
    ...
    person_logo = models.ImageField(upload_to='images/person/', blank=True, verbose_name='لوگو شخص')
...
class Slider(models.Model):
    product = models.ForeignKey(Product, on_delete=models.CASCADE, verbose_name='محصول', default=None)
    title = models.CharField(max_length=200, verbose_name='عنوان')
