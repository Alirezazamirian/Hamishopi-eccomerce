...
(function($) {
        ...
        $('[data-countdown]').each(function() {
            ...
            $this.countdown(finalDate, function(event) {
                var $this = $(this).html(event.strftime(''
                    + '<li class="days_count"><strong>%D</strong><span>روزها</span></li>'
                    + '<li class="hours_count"><strong>%H</strong><span>ساعت ها</span></li>'
                    + '<li class="minutes_count"><strong>%M</strong><span>دقیقه</span></li>'
                    + '<li class="seconds_count"><strong>%S</strong><span>ثانیه</span></li>'));
            });
        });
    });
    ...
    if($("#slider-range").length){
        ...
        $( "#amount" ).val(  + $( "#slider-range" )+"  تومان " .slider( "values", 0 ) +
             $( "#slider-range" )  +"  تومان ".slider( "values", 1 ) );
    }
